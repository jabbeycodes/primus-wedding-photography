...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "A 25% deposit secures your date, with the balance due 14 days before your wedding. Flexible payment plans are available — just ask. We accept Cash App ($primus10) and Zelle (336) 457-2361 — Joshua Abbey.",
      },
    },
  ],
};
    ...
    <html lang="en">
      <head>
        ...
        <link
          ...
          rel="stylesheet"
        />
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-9K9N3H7K1N" />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-9K9N3H7K1N');`,
          }}
        />
      </head>
